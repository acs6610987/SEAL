...
namespace seal
{
    namespace util
    {
        ...
        public:
            ...
            inline Pointer<SEAL_BYTE> &operator =(Pointer<SEAL_BYTE> &&assign) noexcept
            {
        ...
        public:
            ...
            inline Pointer &operator =(Pointer<T> &&assign) noexcept
            {
                acquire(std::move(assign));
                return *this;
            }

            inline Pointer &operator =(Pointer<SEAL_BYTE> &&assign)
            {
                acquire(std::move(assign));
                return *this;
            }
        ...
        public:
            ...
            inline ConstPointer<SEAL_BYTE> &operator =(ConstPointer<SEAL_BYTE> &&assign) noexcept
            {
                acquire(std::move(assign));
                return *this;
            }

            inline ConstPointer<SEAL_BYTE> &operator =(Pointer<SEAL_BYTE> &&assign) noexcept
            {
                acquire(std::move(assign));
                return *this;
            }
        ...
        public:
            ...
            inline ConstPointer<T> &operator =(ConstPointer<T> &&assign) noexcept
            {
                acquire(std::move(assign));
                return *this;
            }

            inline ConstPointer<T> &operator =(ConstPointer<SEAL_BYTE> &&assign)
            {
                acquire(std::move(assign));
                return *this;
            }

            inline ConstPointer<T> &operator =(Pointer<T> &&assign) noexcept
            {
                acquire(std::move(assign));
                return *this;
            }

            inline ConstPointer<T> &operator =(Pointer<SEAL_BYTE> &&assign)
            {
                acquire(std::move(assign));
                return *this;
            }
